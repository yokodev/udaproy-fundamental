...
const Book = ({ book, onMoveToShelf }) => {
  const { authors, imageLinks: { thumbnail = 'nodata' } = 'nodata', shelf, title } = book
    ...
    <div className="book">
      <div className="book-top">
        ...
        <div className="book-shelf-changer">
          <select defaultValue={shelf ? shelf : 'none'} onChange={event => onMoveToShelf(book, event.target.value)}>
